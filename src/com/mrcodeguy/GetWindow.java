...
public class GetWindow extends JFrame {
    public GetWindow() {
        ...
        JLabel instructionsLabel = new JLabel("Enter the URL (with parameters) of the page you wish to retrieve using the GET method, then press the enter key.", JLabel.CENTER);
